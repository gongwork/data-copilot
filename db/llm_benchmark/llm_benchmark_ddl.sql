-- Generated on: 2024-11-26 18:14:46
...
CREATE TABLE IF NOT EXISTS llm (
    ...
    note TEXT  -- Original column: Comment
);
...
CREATE TABLE IF NOT EXISTS question_results (
    ...
    note REAL  -- Original column: comment,
...
-- Original Excel sheet: dataset
CREATE TABLE IF NOT EXISTS dataset (
    title TEXT  -- Original column: title,
    description TEXT  -- Original column: description,
    url TEXT  -- Original column: URL,
    url_2 TEXT  -- Original column: URL-2
);
